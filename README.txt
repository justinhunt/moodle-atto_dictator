...
1. Download
============
Download the plugin from: https://github.com/justinhunt/moodle-atto_dictator
...
Rename the main folder to "dictator." It should contain all the files like "version.php."

Upload the "dictator" folder into the folder
...
Now add Cloud poodll to the menu structure near the bottom of the page
  ...
  e.g style1 = title, bold, italic, dictator
