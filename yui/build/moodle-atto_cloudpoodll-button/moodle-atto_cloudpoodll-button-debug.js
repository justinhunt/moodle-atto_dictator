...
var SKIN = {PLAIN: 'standard',
            ...
            ONCE: 'once'};
var CSS = {
        VIDEO: 'atto_dictator_video',
        AUDIO: 'atto_dictator_audio',
        UPLOAD: 'atto_dictator_upload',
        SUBTITLE: 'atto_dictator_subtitle',
        OPTIONS: 'atto_dictator_options',
        LANG_SELECT: 'atto_dictator_languageselect',
        SUBTITLE_CHECKBOX: 'atto_dictator_subtitle_checkbox',
        MEDIAINSERT_CHECKBOX: 'atto_dictator_mediainsert_checkbox',
        ATTO_CLOUDPOODLL_FORM: 'atto_dictator_form',
        CP_VIDEO: 'atto_dictator_video_cont',
        CP_AUDIO: 'atto_dictator_audio_cont',
        CP_UPLOAD: 'atto_dictator_upload_cont',
...
var TEMPLATES = {
    ...
    ' data-appid="{{CP.appid}}" data-media="video" data-type="{{CP.videoskin}}" data-localloader="/lib/editor/atto/plugins/dictator/poodllloader.html"' +
...
Y.namespace('M.atto_dictator').Button = Y.Base.create('button', Y.M.editor_atto.EditorPlugin, [], {
    initializer: function(config) {
        ...
        CLOUDPOODLL.appid = 'atto_dictator';
